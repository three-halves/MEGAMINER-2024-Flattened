// This is where you build your the Human player interactions with Viseur for the Magomachy game.
import { BaseHumanPlayer } from "src/viseur/game";
import { Game } from "./game";
import { WizardState } from "./state-interfaces";
...
/**
 * This is the class to play the Magomachy game as a human.
...
export class HumanPlayer extends BaseHumanPlayer {
     ...
     * value: Three of the choices a Wizard can make as an action.
     */
    public Action(
        wizard: WizardState,
     ...
     * @param callback - The callback that eventually returns the return value
     * from the server. - The first argument to the callback is the return
     * value: Eight cardinal directions.
     */
    public Move(
        wizard: WizardState,
        callback: (returned: number) => void,
