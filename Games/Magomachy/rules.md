...
#### Defensive Mage
This wizard patiently counters their opponent until an opportunity to retaliate presents itself. They're not very mobile, but they can manipulate their su
...
#### Sustaining Mage
This wizard aims to outlast their opponent in a forced war of attrition. Unfortunately, their attacks can't go through walls and do low damage, so be careful!
...
#### Strategic Mage
This wizard doesn't attack directly, but rather places tactical ~~landmines~~ runes all over the map. EXTREMELY hard to use, but has high potential!
