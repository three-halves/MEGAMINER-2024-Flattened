...
// -- Checkers specific AI actions -- \\

// GotCaptured this is called whenever your checker gets captured (during
// an opponent's turn).
func (ai *AI) GotCaptured(
	// GotCaptured this is called whenever your checker gets captured
