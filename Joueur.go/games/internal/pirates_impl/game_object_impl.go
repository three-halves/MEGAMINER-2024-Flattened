...
// GameObject instances in Pirates.
...
// Game returns a pointer to the Pirates Game instance
func (gameObjectImpl *GameObjectImpl) Game() pirates.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = piratesDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
