...
// GameObject instances in Stumped.
...
// Game returns a pointer to the Stumped Game instance
func (gameObjectImpl *GameObjectImpl) Game() stumped.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = stumpedDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
