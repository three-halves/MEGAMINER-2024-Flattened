...
// GameObject instances in Newtonian.
...
// Game returns a pointer to the Newtonian Game instance
func (gameObjectImpl *GameObjectImpl) Game() newtonian.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = newtonianDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
