...
// GameObject instances in Jungle.
...
// Game returns a pointer to the Jungle Game instance
func (gameObjectImpl *GameObjectImpl) Game() jungle.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = jungleDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
