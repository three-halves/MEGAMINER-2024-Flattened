...
// GameObject instances in Anarchy.
...
// Game returns a pointer to the Anarchy Game instance
func (gameObjectImpl *GameObjectImpl) Game() anarchy.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = anarchyDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
