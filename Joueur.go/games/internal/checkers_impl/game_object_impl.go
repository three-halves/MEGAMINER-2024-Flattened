...
// GameObject instances in Checkers.
...
// Game returns a pointer to the Checkers Game instance
func (gameObjectImpl *GameObjectImpl) Game() checkers.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = checkersDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
