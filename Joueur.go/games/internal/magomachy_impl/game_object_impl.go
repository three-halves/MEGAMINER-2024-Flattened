...
// GameObject instances in Magomachy.
...
// Game returns a pointer to the Magomachy Game instance
func (gameObjectImpl *GameObjectImpl) Game() magomachy.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = magomachyDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
