...
// GameObject instances in Spiders.
...
// Game returns a pointer to the Spiders Game instance
func (gameObjectImpl *GameObjectImpl) Game() spiders.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = spidersDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
