...
// GameObject instances in Necrowar.
...
// Game returns a pointer to the Necrowar Game instance
func (gameObjectImpl *GameObjectImpl) Game() necrowar.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = necrowarDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
