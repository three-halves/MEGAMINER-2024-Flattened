...
// GameObject instances in Stardash.
...
// Game returns a pointer to the Stardash Game instance
func (gameObjectImpl *GameObjectImpl) Game() stardash.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = stardashDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
