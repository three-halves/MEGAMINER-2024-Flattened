...
// GameObject instances in Catastrophe.
...
// Game returns a pointer to the Catastrophe Game instance
func (gameObjectImpl *GameObjectImpl) Game() catastrophe.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = catastropheDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
