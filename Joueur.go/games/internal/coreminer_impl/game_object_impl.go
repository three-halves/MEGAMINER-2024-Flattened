...
// GameObject instances in Coreminer.
...
// Game returns a pointer to the Coreminer Game instance
func (gameObjectImpl *GameObjectImpl) Game() coreminer.Game {
...
func (gameObjectImpl *GameObjectImpl) DeltaMerge(
	...
	switch attribute {
	case "logs":
		gameObjectImpl.logsImpl = coreminerDeltaMerge.ArrayOfString(&gameObjectImpl.logsImpl, delta)
		return true, nil
	}
