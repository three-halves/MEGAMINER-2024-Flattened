...
// -- Magomachy specific AI actions -- \\

// Action this is called whenever your wizard selects an action.
func (ai *AI) Action(
	// Action this is called whenever your wizard selects an action.
	wizard Wizard,
) int64 {
...
// Move this is called whenever your wizard makes a move.
func (ai *AI) Move(
	// Move this is called whenever your wizard makes a move.
	wizard Wizard,
) int64 {
