...
class AI(BaseAI):
    ...
    @property
    def game(self) -> 'games.necrowar.game.Game':
        """games.necrowar.game.Game: The reference to the Game instance this AI is playing.
        """
        return self._game # don't directly touch this "private" variable pls

    @property
    def player(self) -> 'games.necrowar.player.Player':
        """games.necrowar.player.Player: The reference to the Player this AI controls in the Game.
        """
    ...
    def find_path(self, start: 'games.necrowar.tile.Tile', goal: 'games.necrowar.tile.Tile') -> List['games.necrowar.tile.Tile']:
        """A very basic path finding algorithm (Breadth First Search) that when given a starting Tile, will return a valid path to the goal Tile.

        Args:
            start (games.necrowar.tile.Tile): The starting Tile to find a path from.
            goal (games.necrowar.tile.Tile): The goal (destination) Tile to find a path to.

        Returns:
            list[games.necrowar.tile.Tile]: A list of Tiles representing the path, the the first element being a valid adjacent Tile to the start, and the last element being the goal.
        """
