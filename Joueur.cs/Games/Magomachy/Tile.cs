...
namespace Joueur.cs.Games.Magomachy
{
    ...
    /// A Tile in the game that makes up the 2D map grid.
    /// </summary>
    public class Tile : Magomachy.GameObject
    {
        #region Properties
        /// <summary>
        /// The Item on this Tile if present, otherwise null.
        /// </summary>
        public Magomachy.Item Object { get; protected set; }

        /// <summary>
        /// The Tile to the 'East' of this one (x+1, y). Null if out of bounds of the map.
        /// </summary>
        public Magomachy.Tile TileEast { get; protected set; }

        /// <summary>
        /// The Tile to the 'North' of this one (x, y-1). Null if out of bounds of the map.
        /// </summary>
        public Magomachy.Tile TileNorth { get; protected set; }

        /// <summary>
        /// The Tile to the 'South' of this one (x, y+1). Null if out of bounds of the map.
        /// </summary>
        public Magomachy.Tile TileSouth { get; protected set; }
