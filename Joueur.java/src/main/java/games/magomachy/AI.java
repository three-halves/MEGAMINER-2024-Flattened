...
public class AI extends BaseAI {
    ...
    public String getName() {
        ...
        return "Magomachy Java Player"; // REPLACE THIS WITH YOUR TEAM NAME!
     ...
     * @return Three of the choices a Wizard can make as an action.
     */
    public int Action(Wizard wizard) {
     ...
     * @return Eight cardinal directions.
     */
    public int Move(Wizard wizard) {
