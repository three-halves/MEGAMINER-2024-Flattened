...
/**
 * This is the class to play the Magomachy game. This is where you should build your AI.
 * @memberof Magomachy
 */
class AI extends BaseAI {
  ...
  getName() {
    ...
    return 'Magomachy JavaScript Player';
    // <<-- /Creer-Merge: getName -->>
  }
   ...
   *
   * @param {Magomachy.Wizard} wizard - Wizard performs action.
   * @returns {number} - Three of the choices a Wizard can make as an action.
   */
  Action(wizard) {
   ...
   *
   * @param {Magomachy.Wizard} wizard - Wizard moves.
   * @returns {number} - Eight cardinal directions.
   */
  Move(wizard) {
